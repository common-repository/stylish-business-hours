<?php
   ...
   Description: Displaying your business hours with shortcodes. Show irregular hours like Holidays temporarily.
   Version: 1.0.3
   Author: Designful
   */
define('DF_SBH_BUSINESS_HOUR_VERSION', '1.0.3');
define('DF_SBH_URL', plugin_dir_url( __FILE__ ));
...
require_once SBH_DIR.'/admin/businesshour_ajax.php';

function remove_slash_quotes_sbh($string){
...
class Stylish_Business_List {
	...
	public function deactivate_scripts() {
		...
		?>
			<div class="wd-dr-modal" id="spl2-wd-dr-modal">
			...
			<script type="text/javascript">
				(function($) {
					$(function() {
						var modal = $( '#spl2-wd-dr-modal' );
						var deactivateLink = '';
						// Open modal
						$( '#the-list' ).on('click', '#deactivate-stylish-business-hours', function(e) {
							e.preventDefault();
						...
						modal.on('click', 'button.wd-dr-submit-modal', function(e) {
							...
							var $input = $('.wd-dr-modal-reason-input textarea', modal);
							$.ajax({
								url: 'https://hook.us1.make.com/6eblrd3yp44h631tfwxtlhatnyvjd4p5',
								type: 'POST',
								data: {
									answer: $radio.closest('li').find('.wd-de-reason-text').text(),
